...
public class SplashActivity extends PreferenceActivity {
	...
	private void setProfessor(DBManager manager) {
		...
		manager.insert_prof("p11", "11", "장혁수"); // 캡스톤1
		manager.insert_prof("p12", "12", "박영배");
		manager.insert_prof("p13", "13", "전종훈");
		manager.insert_prof("p14", "14", "이경미");
		manager.insert_prof("p15", "15", "류연승");
		manager.insert_prof("p16", "16", "신민호");
		manager.insert_prof("p17", "17", "홍석원");
		manager.insert_prof("p18", "18", "박현민");
		manager.insert_prof("p19", "19", "김진홍");
		manager.insert_prof("p20", "20", "박승진");
		manager.insert_prof("p21", "21", "김유경");
		manager.insert_prof("p22", "22", "한승철");
		//manager.select_prof();
	}
